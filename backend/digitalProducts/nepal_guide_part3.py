...
def build_geography():
    ...
    flows += img("mountains", caption="Nepāl's extraordinary gradient — tropical Terai in the foreground, 8,000-metre peaks on the horizon")

    flows += section_head("Three Physiographic Zones")
    zones = [
        ("Terai (Inner & Outer)", "Elevation: 70–300 m", "The flat southern lowlands bordering India. Subtropical climate, dense sal forest, fertile farmland. Home to Thāru, Maithilī, and Bhojpurī communities. Contains Chitwan and Bardiyā national parks — habitat of the one-horned rhinoceros and Royal Bengal tiger."),
        ("Pahāḍ — the Hill Zone", "Elevation: 300–3,000 m", "Terraced hillsides of millet, maize, and rice. The most densely settled region, home to Gurung, Magar, Newar, Rāī, Limbu, and Bahun-Chetrī communities. Contains Kāṭhmāṇḍu, Pokhara, and most of Nepāl's historic towns and temples."),
        ("Himal — the High Himalaya", "Elevation: 3,000–8,849 m", "Snow-capped peaks, glaciers, and alpine pastures above the tree line. Inhabited by Śerpā, Tibetan, Mustānge, and other Tibeto-Burman peoples. The source of Nepāl's great river systems and home to the world's highest trekking routes."),
    ]
    ...
    flows.append(body(
        "Nepāl is the source of three of Asia's great river systems, all flowing south into "
        "India's Ganges plain:"
    ))
    rivers = [
        "Kośī (Koshi) — rises in Tibet, drains eastern Nepāl; sacred for the Kirant people",
        "Gaṇḍakī (Gandaki) — includes the Kālī Gaṇḍakī, Trīśulī, and Myāgdī; flows through the Annapūrṇā massif",
        "Karnālī (Karnali) — Nepāl's longest river, rising near Lake Mānasovarar in Tibet; drains far-west Nepāl",
        "Bāgmatī — the sacred river of Kāṭhmāṇḍu, flowing past Paśupatinātha; flows into the Ganges in India",
    ]
    flows += bullet_table(rivers, cols=1)

    flows += section_head("The Eight-Thousanders in Nepāl")
    peaks = [
        ("Sagarmāthā", "8,848.86 m", "Everest — 'Forehead of the Sky' (Nepālī)"),
        ("Kangcenjuṅgā","8,586 m",  "Third highest; on the Nepāl–Sikkim border"),
        ("Loṭse",       "8,516 m",  "Connected to Everest massif; fourth highest"),
        ("Makālu",      "8,463 m",  "Isolated five-sided pyramid; fifth highest"),
        ("Cho Oyu",     "8,188 m",  "Sixth highest; straddles the Nepāl–Tibet border"),
        ("Dhaulagirī",  "8,167 m",  "'White Mountain'; isolated massif near Pokhara"),
        ("Manāslu",     "8,163 m",  "'Mountain of the Spirit'; Gorkhā district"),
        ("Annapūrṇā I", "8,091 m",  "Lowest of the eight-thousanders; most dangerous by fatality ratio"),
    ]
    ...
    flows += section_head("The Six Seasons of Nepāl")
    flows.append(body(
        "Unlike the Western four-season model, traditional Nepālī culture recognises "
    ...
    seasons = [
        ("1. Vasanta ऋतु — Spring",        "Caitra–Vaiśākha (mid-March – mid-May)",
         "Rhododendrons bloom across the hills in waves of crimson and pink. Best season for trekking in the Annapūrṇā and Everest regions. Festivals of Caitra Daśain, Rām Navamī, and Nepālī New Year (Baiśākha 1)."),
        ...
        ("3. Varṣā ṛtu — Monsoon",         "Śrāvaṇa–Bhādra (mid-July – mid-September)",
         "The lifeblood of Nepāl. Roughly 80% of annual rainfall arrives in three months. The hills turn impossibly green. Rice paddies fill. Trekking is difficult due to leeches and flooded trails, but Mustāṅ (in the rain shadow) remains accessible."),
        ("4. Śarada ṛtu — Autumn",         "Āśvina–Kārtika (mid-September – mid-November)",
         "The finest season in Nepāl — clear skies, cool temperatures, and the Himalaya sharply visible after the monsoon rains. Peak festival season: Daśain, Tihāra, Chhaṭha Pūjā. Peak trekking season."),
        ("5. Hemanta ṛtu — Pre-winter",     "Mārgaśīrṣa–Pauṣa (mid-November – mid-January)",
         "Cool and dry. Mornings in Kāṭhmāṇḍu drop to near 0°C; snowfall on passes above 3,500 m. The Terai is pleasantly warm. Maghe Saṅkrānti festival falls in Māgha."),
...
def build_culture():
    ...
    flows += img("festival", caption="Daśain celebrations — the most important festival in the Nepālī year, marking Durgā's victory over the demon Mahiṣāsura")

    flows += section_head("Diversity and Daily Life")
    flows.append(body(
        "Nepāl officially recognises <b>125 ethnic/caste groups</b> and over <b>123 languages</b>. "
        "The <b>Newār</b> people of the Kāṭhmāṇḍu Valley built the valley's extraordinary "
        "architectural heritage over two millennia. The <b>Śerpā</b> of the high Khumbu region "
        "are renowned mountaineers and guardians of Tibetan Buddhist culture. The <b>Thāru</b> "
    ...
    flows.append(Spacer(1, 2*mm))
    flows.append(body(
        "Daily life across Nepāl is structured by <b>dharma</b> — one's duty in accordance with "
    ...
    flows.append(Paragraph(
        "The guest is God — a principle from the Taittirīya Upaniṣad that shapes how Nepālī "
    ...
    flows += section_head("Sacred Animals in Nepāl")
    animals = [
        ...
        ("<b>Dog (Kukur)</b>", "Sacred messenger of Yamārāja, god of death. During Tihāra, every dog in the country — pet or street dog — receives a flower garland, tīkā, and a feast."),
        ("<b>Crow (Kāg)</b>", "Messenger between the living and the ancestors. The first day of Tihāra (Kāg Tihāra) is devoted to feeding crows before any human eats."),
        ...
        ("<b>Peacock (Mayūra)</b>", "Vehicle of Kumāra (Kārttikeya); divine bird associated with beauty and rain. The national bird of Nepāl."),
    ]
    for animal, desc in animals:
        flows.append(Paragraph(f"{animal}: {desc}", ST["body"]))
        flows.append(Spacer(1, 2*mm))

    flows += section_head("Festivals of Nepāl")
    flows.append(body(
        "Nepāl's festival calendar is one of the richest in the world. The Bikram Saṃvat "
        "lunar-solar calendar means festival dates shift annually against the Gregorian calendar."
    ))
    festivals = [
        ("Daśain (Dashain)", "Āśvina–Kārtika (Sep–Oct), 15 days",
         "The most important festival in Nepāl — fifteen days honouring Durgā's victory over the buffalo-demon Mahiṣāsura. The main days: Phūlapātī (seventh, flowers brought), Mahāaṣṭamī (eighth, animal sacrifices at Kālī temples), Navamī (ninth, largest sacrifice day), Vijayā Daśamī (tenth, families gather for elders to apply jamārā — sprouted barley — and tīkā on foreheads). Government offices, banks, and schools close for the full ten main days. Traffic out of Kāṭhmāṇḍu to home villages reaches fever pitch."),
        ("Tihāra / Yamapañcaka", "Kārtika (Oct–Nov), 5 days",
         "The festival of lights. Five days: Kāg Tihāra (crows), Kukur Tihāra (dogs), Gāī Tihāra + Lakṣmī Pūjā (cows + goddess of wealth), Goru Tihāra / Nepāl Saṃvat New Year, and Bhāī Ṭīkā (sisters apply seven-coloured tīkā on brothers for long life). Homes are lit with thousands of oil lamps on Lakṣmī Pūjā night — the goddess visits only clean, lit houses."),
        ("Holī", "Phālguna (Feb–Mar), 2 days (hills) / 1 day (Terai)",
         "The festival of colours, celebrating spring and the story of Prahlāda's devotion to Viṣṇu. Coloured powder (abīra) and water are thrown with joyful abandon. The Terai celebrates a day earlier than the hills. Bonfires (Holīkā Dahan) on the night before mark the burning of the demoness Holīkā."),
        ...
        ("Sauṇe Saṅkrānti", "Śrāvaṇa 1 (mid-July)",
        ...
        ("Māghī", "Māgha 1 (mid-January)",
         "Thāru New Year — the most important festival for the Thāru people of the western Terai. Communities gather, elect village leaders, dance and feast. A transition of community roles and contracts."),
        ("Maghe Saṅkrānti", "Māgha 1 (mid-January)",
        ...
        ("Lhosār", "Phālguna or Māgha (Feb–Mar, varies by community)",
         "Tibetan–Buddhist New Year, celebrated most prominently by Śerpā, Gurung (Tamu Lhosār in December), and Tamāṅ (Tamāṅ Lhosār in January) communities. Prayer flags are raised, monasteries hold ceremonies, and communities feast together."),
        ("Śivarātri", "Phālguna dark fortnight (Feb–Mar)",
         "Śiva's great night — one of the holiest nights of the Hindu year. The Paśupatinātha complex in Kāṭhmāṇḍu receives over a million pilgrims including tens of thousands of Hindu sādhus (holy men) from across South Asia, many arriving months in advance."),
        ("Indra Jātrā", "Bhādra (Aug–Sep), 8 days",
         "See Jātras section below — this is Kāṭhmāṇḍu's most spectacular public festival."),
    ]
    ...
    flows.append(body(
        ...
        "Nepāl's Newār cities hold more Jātras than any comparable area on earth."
    ))
    flows.append(Spacer(1, 2*mm))
    jatras = [
        ("Indra Jātrā", "Kāṭhmāṇḍu, Bhādra (Aug–Sep), 8 days",
         "The valley's greatest spectacle. The living Kumārī (child goddess), Gaṇeśa, and Bhairava are taken through the streets in towering wheeled chariots. The Lākhe demon-dancer performs nightly. Giant masked Bhairava faces discharge rice beer from their mouths at the Hanumān Ḍhokā. Inaugurated by Pṛthvī Nārāyaṇa Śāha to legitimise his conquest of Kāṭhmāṇḍu."),
        ("Gāī Jātrā", "Kāṭhmāṇḍu Valley, Bhādra (Aug–Sep)",
        ...
        ("Ghoḍe Jātrā", "Kāṭhmāṇḍu's Tuṇḍikhel, Caitra (March–April)",
         "The Horse Festival — a military horse parade on the open ground of Tuṇḍikhel. Tradition holds that galloping horses drive away the demon Tuṇḍa buried beneath the ground. The army displays equestrian skills; the president attends."),
        ("Rato Matsyendranātha Jātrā", "Pāṭan (Lalitapur), Caitra–Vaiśākha (April–May)",
         "The longest chariot festival in the world — the towering chariot of Rato (Red) Matsyendranātha, patron deity of the Kāṭhmāṇḍu Valley and god of rain and harvest, is pulled through Pāṭan over several months. The chariot can reach 18 metres in height. It culminates with the Bhaṭo Jātrā (see below)."),
        ...
        ("Pānauti Jātrā", "Pānauti, Māgha (January–February), every 12 years",
         "Pānauti hosts the <b>Māgha Sṭhānaka Mela</b> — a great religious fair held every twelve years at the confluence of three rivers (Rośī, Puñyamatī, and the invisible Lūhku Nārāyaṇī). The 2020 mela drew hundreds of thousands of pilgrims. One of the most sacred pilgrimage sites near Kāṭhmāṇḍu."),
        ("Biskā Jātrā", "Bhaktapur, Baiśākha (April), New Year",
        ...
        ("Bhaṭo Jātrā", "Javalakhel, Pāṭan, Jyaiṣṭha (May–June)",
    ...
    flows += section_head("Public Holidays in Nepāl")
    holidays = [
        ("Pṛthvī Jayantī",           "Pauṣa 27 (Jan 11)",     "Birthday of Pṛthvī Nārāyaṇa Śāha"),
        ("Martyr's Day",              "Māgha 5 (Jan 19/20)",    "Commemorating those who died for democracy"),
        ("Maghe Saṅkrānti",           "Māgha 1 (Jan 15)",       "Winter solstice holy bathing"),
        ("Śivarātri",                 "Phālguna (Feb/Mar)",      "Śiva's night; Paśupatinātha pilgrimage"),
        ("Phāgu Pūrṇimā (Holī)",      "Phālguna (Feb/Mar)",     "Festival of colours"),
        ("Bāladevī Caturtha",         "Caitra (Mar)",            "Newār festival"),
        ("Ghoḍe Jātrā / Pāḍavā",     "Caitra (Mar/Apr)",       "Horse festival; spring new year"),
        ("Rāma Navamī",               "Caitra (Mar/Apr)",        "Rāma's birthday"),
        ("Baiśākha 1 — New Year",     "Baiśākha (Apr 14/15)",   "Nepālī New Year"),
        ...
        ("Ghatasthāpanā",             "Āśvina (Sep/Oct)",       "First day of Daśain — sacred water vessel"),
        ("Phūlapātī",                 "Āśvina 7th (Sep/Oct)",   "Seventh day of Daśain — flowers brought"),
        ("Vijayā Daśamī",             "Āśvina 10th (Sep/Oct)",  "Main Daśain day — tīkā from elders"),
        ("Lakṣmī Pūjā",               "Kārtika (Oct/Nov)",      "Third night of Tihāra — goddess of wealth"),
        ("Bhāī Ṭīkā",                 "Kārtika (Oct/Nov)",      "Fifth day of Tihāra — sister-brother bond"),
    ...
    flows.append(body(
        "<b>Jyotiṣa</b> (astrology / the science of light) is not a fringe interest in Nepāl — "
    ...
    flows.append(Spacer(1, 2*mm))
    flows.append(body(
        "The Nepālī system uses <b>27 nakṣatras</b> (lunar mansions) — star-clusters through "
    ...
    flows += section_head("Cultural Dances of Nepāl")
    dances = [
        ("Thāru Dance","Terai (western lowlands)",
         "Performed by the Thāru indigenous people during harvest festivals and community celebrations. Varieties include the <i>Devi Dance</i>, the <i>Jhumra</i>, and the <i>Stick Dance (laṭhī nāca)</i>. Thāru dance is characterised by rapid footwork and group synchronisation, often performed around a central fire at night."),
        ("Deudā Dance","Far-west Nepāl (Surkhet, Dadeldhura, Baitadi)",
         "A sung-dance performed in large circles, especially during Tīja and other hill festivals in the Karnālī and Setī zones. Men and women hold hands or form lines; songs are improvised call-and-response, often poetic and witty. Deudā music uses the ḍholak drum and a distinctive pentatonic melody."),
        ("Mārunī Dance","Newār and hill communities; Tihāra festival",
         "Performed during Tihāra by troupes going house to house. Traditionally performed by men in women's clothing in graceful, delicate movements. The troupe includes musicians playing sāraṅgī, ḍhol, and flute. Mārunī is one of Nepāl's most recognised folk dance forms."),
        ("Tāmāṅ Selo","Tāmāṅ community; hill districts around Kāṭhmāṇḍu",
         "The signature music and dance of the Tāmāṅ people, played with the <i>damphu</i> frame drum. Tāmāṅ Selo songs tell of love, longing for home, and the hardships of migration. The accompanying dance is expressive and narrative, with the dancer becoming the story."),
        ("Cāṇḍī (Chandi) Dance","Bhaktapur's Nava Durgā festival",
         "A fierce ritual dance of the nine mother goddesses performed exclusively by initiated Newār dancers from specific castes in Bhaktapur's Nava Durgā tradition. Dancers wear elaborate masks representing Durgā and the Aṣṭa Mātr̥kās, performing a year-long cycle of performances that are simultaneously sacred ceremony and living mythology."),
        ("Lākhe Dance","Kāṭhmāṇḍu; Indra Jātrā and other festivals",
        ...
        ("Ghāṭu Dance","Gurung community; spring festivals",
         "A ritualistic narrative dance performed only by young Gurung women, depicting the life and story of the goddess Ghāṭu. Performed during Caitra and Baiśākha. Dancers must undergo a ritual preparation and enter a trance-like state. Ghāṭu is slowly being lost as Gurung communities modernise."),
        ("Rātyaulī Dance","Pan-Nepāl; wedding celebrations",
         "Rātyaulī means 'the night before' — the all-night celebration before a wedding. Women gather, sing bawdy and tender songs about marriage, love, and in-law challenges, and dance through the night. Rātyaulī songs are some of the most poetic in folk Nepālī tradition and vary greatly by region and ethnicity."),
        ("Tīja Dance","Pan-Nepāl (especially Pahāḍ communities); Tīja festival",
    ...
    dos = [
        ...
        "Learn a few <b>Nepālī words</b> — even basic phrases will be met with genuine warmth.",
    ...
    donts = [
        ...
        "Don't <b>trek alone</b> in remote areas — register with TAAN (Trekking Agencies' Association of Nepāl) and use a licensed guide.",
        ...
        "Don't disrespect the <b>Svastika</b> — it is an ancient sacred symbol (meaning 'all is well') in Nepāl, unrelated to its 20th-century misappropriation in Europe.",
    ]
    flows += sub_head("✓ Dos")
